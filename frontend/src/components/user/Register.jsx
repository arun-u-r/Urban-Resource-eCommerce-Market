        ...
        >
          <div className="max-w-xl mx-auto text-white">
            <form onSubmit={submitHandler} className='shadow-lg' encType='multipart/form-data'>
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-1 gap-1">{/*cols-2 */}
                <div>
                  <label
                  ...
                  >Full Name</label>
                  <input
                    className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 
            text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                ...
                <div >
                  ...
                  <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full 
                    bg-gray-800 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                    type="email"
                    id="email"
                    name='email'
                ...
                {/* <div>
                  ...
                  <input className="border rounded-lg px-3 py-2 mt-1 mb-4 text-sm w-full bg-gray-800 
                    text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                    type="text"
                    id="username"
                  />
                ...
                <div className='' >
                  ...
                  <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 
                  text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                    type="password"
                    id="password"
                    name="password"
              ...
              <div className="flex items-center  justify-center mt-1">
                <div>
                  <figure className="mr-4 mt-1">
                    <img src={avatarPreview} className="h-16 w-16 rounded-full" alt="image" />
                  </figure>
                </div>
                <div className="relative">
                  <label htmlFor="avatar_upload" className="block text-sm justify-center font-medium text-white-700">Avatar</label>
                  <input
                    type="file"
                    name="avatar"
                    className="sr-only"
                    ...
                    id="customFile"
                  />
                  <label className="cursor-pointer bg-black text-sm text-white py-2 px-3 border 
              ...
              <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  >Gender</label
                  >
                  <select className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 
                   text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                    id="gender">
              ...
              <div className="flex justify-center items-center">
                <div>
                  <button className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 
                   focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition 
                  ...
                  <button
                    className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 
                     focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition 
                     ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none 
                     focus:ring-2 focus:ring-offset-2 rounded-lg mt-4"
                  >
                    <svg
                      viewBox="0 0 30 30"
                      height="30"
              ...
              <div className="mt-5">
                <button className="py-2 px-4 bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 shadow-md
                 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center 
                  text-base font-semibold focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                  type="submit"
                  disabled={loading}
                >
                  Sign up
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <a className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline"
                href="/login">have an account? Log in</a>
              <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4"></span>
            </div>
          </div>
        </div>
