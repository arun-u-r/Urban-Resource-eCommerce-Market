...
import Input from '../extra components/input/Input'
...
const Login = () => {
    ...
    return (
        <Fragment>
            <MetaData title={'Login to u r'} />
            <div className="relative py-3 sm:max-w-xl sm:mx-auto w-full">
                <div
                    className="relative px-4 py-10 bg-green-50 mx-8 md:mx-0 shadow rounded-3xl sm:p-10"
                >
                    <div className="max-w-md mx-auto text-white">
                        <div className="flex items-center space-x-5 justify-center ">
                            <img src='/u-r-header-logo-transparent.svg' className='h-20 mb-5' />
                        </div>
                        <form onSubmit={submitHandler}>
                            <div className="mt-3 ">
                                ...
                                <input
                                    id="login"
                                    type="text"
                                    className="border rounded-lg px-3 py-2 mt-1 mb-3 text-sm w-full bg-gray-700 
                                text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500"
                                    value={email}
